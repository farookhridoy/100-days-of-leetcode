...
def longestPalindrome(s: str) -> str:
    ...
    length = 2 * len(s)+1
    # List to store the length of each palindrome charecter at each element

    p = [0]*length
    # Current center of the longest palindrome charecter & Right boundary of the longest palindromic string also the maxLength of the substring
    c = r = maxLength = 0
...
# Test case
string = 'abbaa'
lpd = longestPalindrome(string)

print('Longest Palindrome is '+string+' : ' + str(lpd))
